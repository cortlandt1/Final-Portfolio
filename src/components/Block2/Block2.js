...
function Block2(props) {
  ...
  return (
    ...
    <div className='test'>
      ...
      <AppCardLeft hash='pXVLMq' name="cortlandt1" title="Hangman Game" point1="Built entirely using vanilla Javascript" point2="Written with full win-lose scenarios and automatic game reset functions" point3="For loops used for the main game mechanic"> </AppCardLeft>
      <AppCardRight hash='dBwZNW' name="cortlandt1" title="Train Scheduler" point1="Utilizes Firebase for data storage" point2="Javascript written using jQuery library" point3="Moment.js used to calculate scheduling"></AppCardRight>
      ...
      <Technologies className="tech"></Technologies>
    </div>
    </>
  );
}
